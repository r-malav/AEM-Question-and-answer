...
**Q1: How to read a property "jcr:title" from a resource?**<br /> 
```java
String title = resource.getValueMap().get("jcr:title", String.class);
```

**Q2: How to get the Page object from a Resource?**<br /> 
```java
Page page = resource.adaptTo(Page.class);
```

**Q3: How to list all immediate child pages of a parent page?**<br /> 
```java
...
**Q5: How to check if a page is "Hidden in Navigation"?**<br /> 
`page.isHideInNav();`

**Q6: How to get the template path of a page?**<br /> 
`page.getTemplate().getPath();`

**Q7: How to get the ResourceResolver from a request?**<br /> 
`request.getResourceResolver();`

**Q8: How to get a Page object if you have a path string?**<br /> 
```java
PageManager pm = resolver.adaptTo(PageManager.class);
Page page = pm.getPage("/content/site/en");
```

**Q9: Difference between `resource.adaptTo(ValueMap.class)` and `resource.getValueMap()`?**<br /> 
`getValueMap()` is a convenience method; both return the same properties.

**Q10: How to get the content resource of a page?**<br /> 
...
**Q13: Why avoid Path-based servlets?**<br /> 
Security risks (bypass JCR ACLs), difficult to overlay, and hard to manage across environments.

**Q14: Difference between `SlingSafeMethodsServlet` and `SlingAllMethodsServlet`?**<br /> 
Safe = GET (Read-only). All = POST, PUT, DELETE (Write).

**Q15: How to get selectors from a servlet request?**<br /> 
`request.getRequestPathInfo().getSelectors();`

**Q16: How to write a JSON response?**<br /> 
```java
response.setContentType("application/json");
response.getWriter().write("{\"key\":\"value\"}");
```

**Q17: How to get a parameter from the URL?**<br /> 
`request.getParameter("id");`

**Q18: What is the default servlet in Sling?**<br /> 
The `DefaultServlet` which renders the resource based on script resolution.

**Q19: How to get the suffix from a URL?**<br /> 
`request.getRequestPathInfo().getSuffix();`

**Q20: How to redirect from a servlet?**<br /> 
...
**Q31: How to create an OSGi Config?**<br /> 
```java
...
**Q32: Where are OSGi configs stored in JCR?**<br /> 
Under `/apps/myapp/config` or `/apps/myapp/config.author`.

**Q33: How to create environment-specific configs?**<br /> 
Using runmode folders (e.g., `config.prod`, `config.dev`).

**Q34: Can you read OSGi config in HTL?**<br /> 
No, you must read it in a Sling Model or Service first.

**Q35: What is the file extension for modern OSGi configs?**<br /> 
`.cfg.json`.
...
**Q38: What are the scopes for filters?**<br /> 
`REQUEST`, `COMPONENT`, `ERROR`, `FORWARD`, `INCLUDE`.

**Q39: How to pass the request to the next filter?**<br /> 
`chain.doFilter(request, response);`

**Q40: Why use `service.ranking` in filters?**<br /> 
...
**Q41: Difference between `EventListener` and `ResourceChangeListener`?**<br /> 
...
**Q43: What is the `EventAdmin`?**<br /> 
An OSGi service used to send and receive asynchronous events.

**Q44: How to trigger an event manually?**<br /> 
`eventAdmin.postEvent(new Event("my/topic", map));`

**Q45: How to avoid infinite loops in listeners?**<br /> 
...
**Q46: How to create a Scheduler using Runnable?**<br /> 
```java
...
**Q50: How to stop a running scheduler?**<br /> 
...
**Q51: How to get the TagManager?**<br /> 
`resolver.adaptTo(TagManager.class);`

**Q52: How to get tags from a Page?**<br /> 
`page.getTags();`

**Q53: How to read a Tag title?**<br /> 
`tag.getTitle();`

**Q54: How to find pages with a specific tag?**<br /> 
`tagManager.find("/content/tags/my-tag", new String[]{"/content/site"});`

**Q55: How to get localized tag titles?**<br /> 
...
**Q56: `@ValueMapValue` vs `@Inject`?**<br /> 
...
**Q59: How to handle default values in Sling Models?**<br /> 
`@Default(values = "N/A")`.

**Q60: How to export a Sling Model as JSON?**<br /> 
